...
| :-----------: | :------------------------------------------------------------------: | :-------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
| stage info | 8 | no | [src/wasm/mem_layout.rs](./src/wasm/mem_layout.rs) |
| sprite info | 80 \* number of sprites (i.e. `target num - 1`) | yes | see [src/wasm/mem_layout.rs](./src/wasm/mem_layout.rs) |
