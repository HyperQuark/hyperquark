<template>
  <ProjectPlayer v-if="success === true" :json="json" :id="props.id" :author="author" :title="title" :instructions="instructions" :description="description" :zip="null"></ProjectPlayer>
  <template v-else>
