...
import {
  ...
  WasmFeature,
  all_wasm_features,
  wasm_feature_detect_name,
} from "../../js/no-compiler/hyperquark.js";
...
export const defaultSettings = new WasmFlags(
  Array.from(supportedWasmFeatures, (feat) => WasmFeature[feat]),
);
...
function settingsInfoFromType(type) {
  if (type === "boolean") {
    ...
    return {
      type: "radio",
      options: Object.keys(hyperquarkExports[type]).filter(
...
export const settingsInfo = Object.fromEntries(
  Object.entries(Object.getOwnPropertyDescriptors(WasmFlags.prototype))
